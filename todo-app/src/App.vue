<template>
  <v-app>
    <!-- 전체 영역을 카드 UI로 변경하여 색상의 일관성 유지 -->
    <v-card>
      <v-app-bar color="lime" dark>
        <!-- 왼쪽에 메뉴 아이콘을 넣음 -->
              ...
              <v-list two-line v-for="item in oTodos" :key="item.key">
                ...
                <v-card v-else dark>
                  <v-list-item class="py-2">
                    ...
                    <v-card-actions>
                      <!-- 수정모드에서 '저장' 아이콘을 클릭하면 해당 item 저장 -->
